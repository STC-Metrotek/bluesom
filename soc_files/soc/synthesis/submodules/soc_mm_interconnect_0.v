...
// 
// Generated using ACDS version 14.0 200 at 2016.11.02.14:24:47
...
module soc_mm_interconnect_0 (
	...
	wire   [29:0] pio_led_s1_agent_m0_address;                                    // pio_led_s1_agent:m0_address -> pio_led_s1_translator:uav_address
	...
	wire  [122:0] onchip_memory_s1_agent_rp_data;                                 // onchip_memory_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [122:0] pio_led_s1_agent_rp_data;                                       // pio_led_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [122:0] sysid_qsys_0_control_slave_agent_rp_data;                       // sysid_qsys_0_control_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [122:0] cmd_mux_src_data;                                               // cmd_mux:src_data -> onchip_memory_s1_burst_adapter:sink0_data
	wire    [2:0] cmd_mux_src_channel;                                            // cmd_mux:src_channel -> onchip_memory_s1_burst_adapter:sink0_channel
	...
	wire    [2:0] onchip_memory_s1_burst_adapter_source0_channel;                 // onchip_memory_s1_burst_adapter:source0_channel -> onchip_memory_s1_agent:cp_channel
	...
	wire  [122:0] cmd_mux_001_src_data;                                           // cmd_mux_001:src_data -> pio_led_s1_burst_adapter:sink0_data
	...
	wire  [122:0] cmd_mux_002_src_data;                                           // cmd_mux_002:src_data -> sysid_qsys_0_control_slave_burst_adapter:sink0_data
	...
	altera_merlin_axi_master_ni #(
		...
		.aresetn                (~onchip_memory_reset1_reset_bridge_in_reset_reset),     //        clk_reset.reset_n
